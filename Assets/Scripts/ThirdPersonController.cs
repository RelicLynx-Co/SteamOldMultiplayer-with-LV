...
#endif
	public class ThirdPersonController : NetworkBehaviour // MonoBehaviour
	{
		...
		public override void OnNetworkSpawn()
		{
			...
			{
				GameObject cam = Instantiate( _FreeLookCam );
				CinemachineVirtualCamera CMVC = cam.GetComponent<CinemachineVirtualCamera>();
				if ( CMVC != null ) {
					CMVC.Follow = CinemachineCameraTarget.transform;
				}
			}
		}

		// [FIX] might be Null and cause an error
		private void Start()
		{
